...
@section('title', 'Halaman Tidak Ditemukan - EduMentor')
    ...
    <div class="flex-1 flex items-center justify-center px-margin-mobile md:px-margin-desktop relative z-10">
        <div class="max-w-lg w-full text-center">
            <div class="mb-8 flex justify-center">
                <div class="w-24 h-24 bg-primary-container rounded-3xl flex items-center justify-center shadow-lg shadow-primary/20">
                    <span class="material-symbols-outlined text-on-primary-container text-[64px]" style="font-variation-settings: 'FILL' 1;">search_off</span>
                </div>
            </div>

            <div class="inline-flex items-center gap-2 rounded-full bg-secondary-container/20 px-4 py-2 border border-secondary-container/30 mb-6">
                <span class="material-symbols-outlined text-on-secondary-container text-[18px]" style="font-variation-settings: 'FILL' 1;">error</span>
                <span class="font-label-md text-label-md text-on-secondary-container font-semibold">Error 404</span>
            </div>

            <h1 class="font-display-lg text-display-lg text-on-surface mb-4 leading-tight tracking-tight">
                <span class="text-primary bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Oops!</span> Halaman Tidak Ditemukan
            </h1>
            ...
            <div class="flex flex-col gap-4 sm:flex-row justify-center">
                <a href="{{ url('/') }}" class="inline-flex items-center justify-center gap-2 rounded-xl px-6 py-4 font-label-md text-label-md bg-primary text-on-primary shadow-lg shadow-primary/20 hover:bg-primary-container hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 active:scale-[0.98]">
                    <span class="material-symbols-outlined text-[20px]">home</span>
                    Kembali ke Beranda
                </a>
                <a href="{{ url()->previous() }}" class="inline-flex items-center justify-center gap-2 rounded-xl px-6 py-4 font-label-md text-label-md text-on-surface border border-outline-variant hover:bg-surface-container-low transition-all duration-200">
            ...
            <div class="mt-12 pt-8 border-t border-outline-variant/30">
                <p class="font-label-sm text-label-sm text-on-surface-variant">
                    Butuh bantuan? <a href="mailto:support@edumentor.test" class="text-primary hover:underline font-semibold">Hubungi Support</a>
                </p>
            </div>
        </div>
    </div>
