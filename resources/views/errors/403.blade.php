...
@section('title', 'Akses Ditolak - EduMentor')
        ...
        <div class="max-w-lg w-full text-center">
            <div class="mb-8 flex justify-center">
                <div class="w-24 h-24 bg-error-container rounded-3xl flex items-center justify-center shadow-lg shadow-error/20">
                    <span class="material-symbols-outlined text-on-error-container text-[64px]" style="font-variation-settings: 'FILL' 1;">shield_locked</span>
                </div>
            </div>
            ...
            <div class="inline-flex items-center gap-2 rounded-full bg-error-container/20 px-4 py-2 border border-error-container/30 mb-6">
                <span class="material-symbols-outlined text-on-error-container text-[18px]" style="font-variation-settings: 'FILL' 1;">warning</span>
                <span class="font-label-md text-label-md text-on-error-container font-semibold">Error 403</span>
            </div>

            <h1 class="font-display-lg text-display-lg text-on-surface mb-4 leading-tight tracking-tight">
                Akses <span class="text-error bg-gradient-to-r from-error to-error-container bg-clip-text text-transparent">Ditolak</span>
            </h1>

            <p class="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-md mx-auto">
                Anda tidak memiliki izin untuk mengakses halaman ini. Silakan masuk dengan akun yang memiliki hak akses yang tepat.
            </p>
            ...
            <div class="flex flex-col gap-4 sm:flex-row justify-center">
                ...
                @else
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center gap-2 rounded-xl px-6 py-4 font-label-md text-label-md bg-primary text-on-primary shadow-lg shadow-primary/20 hover:bg-primary-container hover:shadow-xl hover:shadow-primary/30 transition-all duration-300 active:scale-[0.98]">
            ...
            <div class="mt-12 pt-8 border-t border-outline-variant/30">
                <p class="font-label-sm text-label-sm text-on-surface-variant">
                    Tidak yakin dengan hak akses Anda? <a href="mailto:support@edumentor.test" class="text-primary hover:underline font-semibold">Hubungi Administrator</a>
                </p>
            </div>
        </div>
    </div>
